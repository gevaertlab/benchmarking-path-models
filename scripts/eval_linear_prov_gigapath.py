...
def eval_linear(args):
    ...
    if 'scratch' in args.train_from_scratch:
        ...
        local_dir='/lus/grand/projects/RNAtoImage/rbareja/path_benchmarking/models/pathology/7-prov-gigapath'
        config = json.load(open(os.path.join(local_dir, "config.json")))
...
# https://github.com/prov-gigapath/prov-gigapath/issues/89 setting up code
